...
class CommandLineParserTest extends AssertionsForJUnit {
  ...
  def test01_configFile{
    ...
    assert(result1 == CommandLine(ConfigFile("test")))
    val result2 = p.parse("--config test")
    assert(result2 == CommandLine(ConfigFile("test")))
  }
  ...
  def test01_configFile_id{
    ...
    assert(result1 == CommandLine(ConfigFile("test", List("test"))))
    val result2 = p.parse("--config [test]@test")
    assert(result2 == CommandLine(ConfigFile("test", List("test"))))
  ...
  def test01_configFile_ids{
    ...
    assert(result1 == CommandLine(ConfigFile("test", List("test1","test2","test3"))))
    val result2 = p.parse("--config [test1,test2,test3]@test")
    assert(result2 == CommandLine(ConfigFile("test", List("test1","test2","test3"))))
  }
  ...
  def test01_configFile_templateDir{
    ...
    assert(result1 == CommandLine(ConfigFile("test"), Some("template")))
    val result2 = p.parse("-c test --template template")
    assert(result2 == CommandLine(ConfigFile("test"), Some("template")))
  }
  ...
  def test01_configFile_exportDir{
    ...
    assert(result1 == CommandLine(ConfigFile("test"), None, Some("export")))
    val result2 = p.parse("-c test --export export")
    assert(result2 == CommandLine(ConfigFile("test"), None, Some("export")))
  }
